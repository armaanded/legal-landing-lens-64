  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        <h1 className={`font-playfair text-4xl md:text-5xl lg:text-7xl font-light text-white mb-8 leading-tight transition-opacity duration-700 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
          {lines[0]}
