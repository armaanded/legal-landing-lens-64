    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className={`font-playfair text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 mb-6 leading-tight transition-all duration-700 ${stagger[0] ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 translate-y-4'}`}>
            When the herd follows
            <br />
            <span className="font-medium">We lead differently</span>
          </h2>
          <div className="max-w-4xl mx-auto">
            <p className={`font-inter text-lg text-gray-600 leading-relaxed mb-8 transition-all duration-700 ${stagger[1] ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 translate-y-4'}`}
            >
            ...
            <p className={`font-inter text-lg text-gray-600 leading-relaxed mb-12 transition-all duration-700 ${stagger[2] ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 translate-y-4'}`}
            >
